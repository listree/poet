 ...
 * Runtime: 182 ms, faster than 19.59% of Java online submissions for Find Median from Data Stream.
 * Memory: 120.6 MB, less than 22.81% of Java online submissions for Find Median from Data Stream.
 */
public class FindMedianStream {

    public static void main(String[] args) throws Exception {

        FindMedianStream ha = new FindMedianStream();
        ha.addNum(6);
        System.out.println("Check Answer: " + ha.findMedian());
        ha.addNum(10);
        System.out.println("Check Answer: " + ha.findMedian());
        ha.addNum(2);
        System.out.println("Check Answer: " + ha.findMedian());
    ...
    // number > median with descending order
    private PriorityQueue<Integer> bigQueue = new PriorityQueue<Integer>();
    // number < median ascending order
    private PriorityQueue<Integer> smallQueue = new PriorityQueue<Integer>(Collections.reverseOrder());
    private Integer smallNumber = null;
    private Integer middleNumber = null;
    private Integer bigNumber = null;

    public FindMedianStream() {
